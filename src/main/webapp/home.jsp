...
<head>
    ...
    <style>
        /* CSS for the webpage body */
        body {
            background-image: url('https://img.freepik.com/free-photo/fresh-gourmet-meal-beef-taco-salad-plate-generated-by-ai_188544-13382.jpg?w=1380&t=st=1699076982~exp=1699077582~hmac=5bb8fc07e7e7c0de053c29e02e05557e97b75bf16e3c4c8a8af74678e8a40c48'); /* Replace 'background-image.jpg' with your image URL */
...
.card {
  height: 100%;
  border-radius: 50px;
  background: linear-gradient(135deg, rgb(185, 119, 244)0%, rgb(8, 171, 226) 100%);
...
.dropdown {
    ...
    50% { transform: translateX(200px); } /* Adjust the distance and direction of the movement */
  ...
  .moving-text {
   display: inline-block;
    animation: move 2s forwards; /* Adjust the duration as needed */
    font-weight: bold;
    font-size: 44px;/* Adjust the duration as needed */
  }
...
<body>
    ...
    <div class="heading">
        <h3 style="color: white;"style="font-weight: bold;" >Your Step Delivery</h3>
    </div>
 ...
 <div class="container">
        ...
        <button type="button" class="btn btn-primary open-notification-btn" data-toggle="modal" data-target="#myModal">
            Open Notification
        </button>

        <div class="modal notification" id="myModal">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>orders!</p>
                        <p>order at Gandhinagar</p>
                        <p> >Pizza, Salad, Soda</p>
                    </div>
...
<br>
    <h1><span class="moving-text" style="color: white;">Hey Delivery Boys !!!</span></h1>
<br>
    <center><h4 style="color: white;">Check your orders.. Have a safe drive.. Deliver the need.. Have points..❤️</h4></center>
<br>
...
<p>&nbsp;</p>
    ...
    <div class="parent">
        <div class="card">
            ...
            <div class="glass"></div>
            <div class="content">
                <span class="title">Ctrl + Eat</span>
                <br>
                <span class="title">Orders More Than 500+</span>
            </div>
            <div class="bottom">
    ...
    <div class="parent">
        <div class="card">
            ...
            <div class="content">
                <span class="title">Ctrl + Eat</span>
                <br>
                <span class="title">100+ Delivery Boys</span>
            </div>
            <div class="bottom">
    ...
    <div class="parent">
        <div class="card">
            ...
            <div class="content">
                <span class="title">Ctrl + Eat</span>
                <br>
                <span class="title">400+ Satisfied Customers</span>
            </div>
            <div class="bottom">
